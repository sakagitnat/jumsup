...
export function renderPricing(s,{embedded=false}={}){
 ...
 <section class="pricing-intro"><span class="tag green">Stripe Live · ชำระเงินจริงอย่างปลอดภัยผ่าน Stripe</span><h2>เรียนต่อเนื่องในราคาที่เข้าถึงได้</h2><p>ราคาจะแสดงเป็น ${currency} ตามภาษาที่คุณเลือก และตรงกับ Stripe Checkout</p></section>
