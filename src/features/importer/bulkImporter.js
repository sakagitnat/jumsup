...
const TYPES={
 ...
 listening:{label:"Listening",headers:["conversation_id","part","title","situation","dialogue","question","choice_a","choice_b","choice_c","choice_d","correct_answer","explanation"],required:["conversation_id","part","dialogue","question","choice_a","choice_b","correct_answer"]},
