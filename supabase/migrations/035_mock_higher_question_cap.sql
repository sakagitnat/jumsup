-- Mock exams are naturally longer than a single Reading/Listening/Writing
-- section, so the Free "large set" cutoff for Mock specifically moves from
-- 10 to 30 questions. Reading/Listening/Writing stay at 10.
-- Apply after 034_tighten_free_limits.sql.
